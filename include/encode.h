...
Opr_type check_operation(char *option);  //-e for encoding and -d for decoding

/* Read and validate Encode args from argv */
Status validate_encode_args(char *argv[], EncodeInfo *encInfo);

/* Perform the encoding */
Status do_encoding(char *argv[],EncodeInfo *encInfo); //main function for encoding 
...
/* Get file size */
unsigned int get_file_size(FILE *fptr);  //secret file size
